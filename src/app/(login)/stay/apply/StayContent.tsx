...
const StayContent = ({ init, userInfo }: {
  ...
  const [bySeatsObj, setBySeatsObj] = React.useState<BySeatsObj>(init.bySeatsObj);
  const [byGradeClassObj, setByGradeClassObj] = React.useState<ByGradeClassObj>(init.byGradeClassObj);
  const [studyroom, setStudyroom] = React.useState<StayGetResponse["data"]["studyroom"]>(init.studyroom);
  const [classStay, setClassStay] = React.useState<StayGetResponse["data"]["classStay"]>(init.classStay);
