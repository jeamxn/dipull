...
const LoginedLayout = async ({
  ...
  return (
    <>
      {
        veryfied.ok ? (
          <header className="h-14 z-50 bg-background/50 backdrop-blur-xl fixe top-safe left-0 w-full px-4 border-b border-text/10 flex flex-row items-center justify-center">
