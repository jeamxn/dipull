...
const LuckComponent = ({
  ...
  current: keyof LuckData | null;
  setCurrent: React.Dispatch<React.SetStateAction<keyof LuckData | null>>;
  value: string;
  loading: boolean;
}) => {
  return (
    <article 
      ...
      onClick={() => {
        setCurrent(current === keyString ? null : keyString);
      }}
    >
