...
const JasupStatisticsContent = ({
  ...
  const [gradeClass, setGradeClass] = React.useState<number>(init.gradeClass);
  ...
  const [isSecond, setIsSecond] = React.useState<boolean>(false);
...
export default JasupStatisticsContent;