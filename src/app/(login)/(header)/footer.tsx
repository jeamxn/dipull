  ...
  return isFooter ? (
    <footer className="w-full pt-5 pb-8">
      <article className="w-full flex flex-col justify-center items-center gap-2">
        ...
        <p className="text-text/40 text-sm">오류 및 기타 문의 사항은 <a className="text-primary/40 underline" href="https://github.com/jeamxn/dipull" target="_blank" rel="noreferrer">디풀 개발자 커뮤니티</a>에 연락바랍니다!</p>
      </article>
    </footer>
  ) : null;
};
