  ...
  return (
    <div className="py-6 flex flex-col gap-6">
      ...
      <div className="w-full px-6 flex flex-row gap-3 items-center justify-around border-y border-text/10 dark:border-text/15">
        <div className="flex flex-row gap-1 items-center justify-center cursor-pointer py-3 w-full">
