            ...
            <div className="flex flex-row items-center justify-start gap-1">
              ...
              >
                <svg className="w-4 h-4" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path className={[
                    "transition-all",
                    emotion === "good" || emotion === "initGood" ? "fill-blue-700 dark:fill-blue-400" : "fill-text/50 dark:fill-text-dark/60"
              ...
              >
                <svg className="w-4 h-4" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path className={[
                    "transition-all",
                    emotion === "bad" || emotion === "initBad" ? "fill-blue-700 dark:fill-blue-400" : "fill-text/50 dark:fill-text-dark/60"
