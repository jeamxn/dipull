...
const BambooPageContent = ({
  ...
  const [myEmotion, setMyEmotion] = React.useState<"like" | "dislike" | "">(bamboo.myGood ? "like" : bamboo.myBad ? "dislike" : "");
        ...
        >
          <svg className="w-5 h-5" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g mask="url(#mask0_304_241)">
              <path className={[
                "transition-all",
                myEmotion === "like" ? "fill-blue-700 dark:fill-blue-400" : "fill-text/50 dark:fill-text-dark/60"
          ...
          <p className={[
            ...
            myEmotion === "like" ? "text-blue-700 dark:text-blue-400" : "text-text/50 dark:text-text-dark/60"
          ].join(" ")}>{bamboo.goods}개</p>
        </button>
        <button
          className="flex flex-row gap-1 items-center justify-center cursor-pointer py-3 w-full"
          onClick={() => {
        ...
        >
          <svg className="w-5 h-5" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g mask="url(#mask0_304_246)">
              <path className={[
                "transition-all",
                myEmotion === "dislike" ? "fill-blue-700 dark:fill-blue-400" : "fill-text/50 dark:fill-text-dark/60"
          ...
          <p className={[
            "text-base select-none font-normal",
            myEmotion === "dislike" ? "text-blue-700 dark:text-blue-400" : "text-text/50 dark:text-text-dark/60"
          ].join(" ")}>{bamboo.bads}개</p>
        </button>
        <button
          className="flex flex-row gap-1 items-center justify-center cursor-pointer py-3 w-full"
        >
