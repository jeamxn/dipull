...
const BambooPageContent = ({
  ...
  const { data: reaction, refetch: fetchReaction } = useQuery({
  ...
  // React.useEffect(() => { 
  //   if (myEmotion === "initBad" || myEmotion === "initGood" || myEmotion === "init") return;
  //   refetch();
  // }, [myEmotion]);
        ...
        >
          <svg className="w-5 h-5" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g mask="url(#mask0_304_241)">
              <path className={[
                "transition-all",
                myEmotion === "good" || myEmotion === "initGood" ? "fill-blue-700 dark:fill-blue-400" : "fill-text/50 dark:fill-text-dark/60"
          ...
          <p className={[
            ...
            myEmotion === "good" || myEmotion === "initGood" ? "text-blue-700 dark:text-blue-400" : "text-text/50 dark:text-text-dark/60"
          ].join(" ")}>
            {
        ...
        >
          <svg className="w-5 h-5" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g mask="url(#mask0_304_246)">
              <path className={[
                "transition-all",
                myEmotion === "bad" || myEmotion === "initBad" ? "fill-blue-700 dark:fill-blue-400" : "fill-text/50 dark:fill-text-dark/60"
          ...
          <p className={[
            "text-base select-none font-normal",
            myEmotion === "bad" || myEmotion === "initBad" ? "text-blue-700 dark:text-blue-400" : "text-text/50 dark:text-text-dark/60"
          ].join(" ")}>
            {
